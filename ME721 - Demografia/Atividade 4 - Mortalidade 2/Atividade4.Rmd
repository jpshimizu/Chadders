...
df2$masc <- df$masc - bh_morte_externa_2010$masc
df2$femi <- df$femi - bh_morte_externa_2010$femi
df2$total<- df$total - bh_morte_externa_2010$total
...
```{r}
lt2<-matrix(c(1),11,13)
lt2[,1]<-c(5,5,5,5,rep(10,7))

lt2[,2] <- c(df$masc[1] + df$masc[2], df$masc[3:12])

lt2[,3] <- c(pop_bh_2010$masc[1:4], pop_bh_2010$masc[5] + pop_bh_2010$masc[6], pop_bh_2010$masc[7] + pop_bh_2010$masc[8], pop_bh_2010$masc[9] + pop_bh_2010$masc[10], pop_bh_2010$masc[11] + pop_bh_2010$masc[12], pop_bh_2010$masc[13] + pop_bh_2010$masc[14], pop_bh_2010$masc[15] + pop_bh_2010$masc[16], pop_bh_2010$masc[17] )

lt2[,4]<-lt2[,2]/lt2[,3]

lt2[11,5]<-1/lt2[11,4]

for (i in 1:10){lt2[i,6]<-(lt2[i,1]*lt2[i,4])/
...
for(i in 1:11){lt2[i,5]<-lt2[i,6] * pop_bh_2010$masc[i]}

lt2[1,8]<-100000 #estabelecendo a raiz da t�bua

for (i in 2:11){lt2[i,8]<-(lt2[i-1,7]*lt2[i-1,8])}

for (i in 1:10){lt2[i,9]<-lt2[i,8]-lt2[i+1,8]}

lt2[11,9]<-lt2[11,8]

for (i in 1:10){lt2[i,10]<-((lt2[i,1]*lt2[i+1,8])+(lt2[i,5]*lt2[i,9]))}

lt2[11,10]<-lt2[11,9]/lt2[11,4]
...
##colocando o nome das linhas e colunas
rownames(lt2)<-c("0","5","10","15","20","30","40","50","60","70","80+")
...
```{r}
lt4<-matrix(c(1),11,13)
lt4[,1]<-c(5,5,5,5,rep(10,7))

lt4[,2] <- c(df$femi[1] + df$femi[2], df$femi[3:12])

lt4[,3] <- c(pop_bh_2010$femi[1:4], pop_bh_2010$femi[5] + pop_bh_2010$femi[6], pop_bh_2010$femi[7] + pop_bh_2010$femi[8], pop_bh_2010$femi[9] + pop_bh_2010$femi[10], pop_bh_2010$femi[11] + pop_bh_2010$femi[12], pop_bh_2010$femi[13] + pop_bh_2010$femi[14], pop_bh_2010$femi[15] + pop_bh_2010$femi[16], pop_bh_2010$femi[17] )

lt4[,4]<-lt4[,2]/lt4[,3]

lt4[11,5]<-1/lt4[11,4]

for (i in 1:10){lt4[i,6]<-(lt4[i,1]*lt4[i,4])/
...
for(i in 1:11){lt4[i,5]<-lt4[i,6] * pop_bh_2010$femi[i]}

lt4[1,8]<-100000 #estabelecendo a raiz da t�bua

for (i in 2:11){lt4[i,8]<-(lt4[i-1,7]*lt4[i-1,8])}

for (i in 1:10){lt4[i,9]<-lt4[i,8]-lt4[i+1,8]}

lt4[11,9]<-lt4[11,8]

for (i in 1:10){lt4[i,10]<-((lt4[i,1]*lt4[i+1,8])+(lt4[i,5]*lt4[i,9]))}

lt4[11,10]<-lt4[11,9]/lt4[11,4]
...
##colocando o nome das linhas e colunas
rownames(lt4)<-c("0","5","10","15","20","30","40","50","60","70","80+")
