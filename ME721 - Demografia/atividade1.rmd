...
{\large Guilherme Martins de Castro Gurgel - 217249}\\[9cm]
...
```{r, fig.cap="Pirâmide etária do Estado do Ceará, ano 2010"}
df10 %>% ggplot(
    aes(x = Faixa.Etária.detalhada,
        y = perc_pop, fill = sexo)
    ) +
...
```
Observando primeiramente o ano de 1980 vemos que a razão entre os sexos é menor do que um para as faixas etárias maiores que 10 anos, o que, levando em consideração o exercício 1, significa que a população é em sua maioria feminina. 
É importante notar também que isso pode nos sugerir que o indice de saída de homens do Ceará é maior do que o das mulheres, outra possibilidade seria que o tempo médio de vida masculino fosse menor do que o feminino. Podemos observar isso pois apenas na faixa etária de 0 a 9 anos foi registrada uma maioria masculina, tendo pontos mínimos no intervalo de 25 a 29 anos e 80 anos ou mais, registrando respectivamente uma razão de 0,861 e 0,813.
